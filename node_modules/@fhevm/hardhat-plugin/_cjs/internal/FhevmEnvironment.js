...
class FhevmEnvironment {
        ...
        if (this.mockProvider.isMock) {
            ...
            const instance = await (0, node_1.createInstance)({
                ...this.getContractsRepository().getFhevmInstanceConfig({
                    ...
                    relayerUrl: constants_1.default.RELAYER_URL,
                }),
    ...
    async _initializeAddressesCoreSepolia() {
        const fhevmConfig = constants_1.default.SEPOLIA.FHEVMConfig;
        const fhevmConfigDotSolPath = (0, FHEVMConfig_1.generateFHEVMConfigDotSol)(this.paths, fhevmConfig);
        const zamaOracleAddress = {
            SepoliaZamaOracleAddress: constants_1.default.SEPOLIA.ZamaOracleAddress,
        };
    ...
    async _initializeAddressesCore(ignoreCache) {
        const precompiledAddresses = await (0, PrecompiledFhevmCoreContracts_1.loadPrecompiledFhevmCoreContractsAddresses)(this.mockProvider, this.paths, ignoreCache, this.isRunningInHHFHEVMInstallSolidity);
        ...
        const fhevmConfigDotSolPath = (0, FHEVMConfig_1.generateFHEVMConfigDotSol)(this.paths, fhevmConfig);
        const zamaOracleAddress = (0, addresses_1.getDecryptionOracleAddress)();
        const zamaOracleAddressDotSolPath = (0, ZamaOracleAddress_1.generateZamaOracleAddressDotSol)(this.paths, zamaOracleAddress);
        (0, error_2.assertHHFhevm)(path.isAbsolute(fhevmConfigDotSolPath));
        (0, error_2.assertHHFhevm)(path.isAbsolute(zamaOracleAddressDotSolPath));
        return {
            FHEVMConfig: fhevmConfig,
