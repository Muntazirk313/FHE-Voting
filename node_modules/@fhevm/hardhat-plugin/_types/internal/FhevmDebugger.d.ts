...
export declare class FhevmDebugger implements HardhatFhevmRuntimeDebugger {
    ...
    decryptEbytes(fhevmType: FhevmTypeEbytes, handleBytes32: EthersT.BigNumberish): Promise<string>;
    decryptEaddress(handleBytes32: EthersT.BigNumberish): Promise<string>;
}
