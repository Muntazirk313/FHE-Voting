...
export declare namespace FHEVotingSepolia {
...
export interface FHEVotingSepoliaInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "createProposal"
      | "getProposalInfo"
...
export interface FHEVotingSepolia extends BaseContract {
  connect(runner?: ContractRunner | null): FHEVotingSepolia;
  waitForDeployment(): Promise<this>;

  interface: FHEVotingSepoliaInterface;
  ...
  getProposalInfo: TypedContractMethod<
    ...
    [FHEVotingSepolia.ProposalInfoStructOutput],
    "view"
  >;
